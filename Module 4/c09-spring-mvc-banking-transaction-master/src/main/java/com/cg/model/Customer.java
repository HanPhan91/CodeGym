...
public class Customer {
    ...
    public Customer(Long id, String fullName, String email, String phone, String address, BigDecimal balance, Set<Transfer> sender, Set<Transfer> recipient, boolean deleted, Date createdAt, Long createdBy, Date updatedAt, Long updatedBy) {
        this.id = id;
